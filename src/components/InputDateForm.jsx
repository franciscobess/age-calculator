...
const InputDateForm = () => {
    ...
    const formSubmitHandler = (event) => {
        ...
        const day = Number(event.target.day.value)
    ...
    return (
        <div className="mt-[100px]">
            <form className="flex justify-center" onSubmit={formSubmitHandler}>
                <BiReset className="mt-6 mr-2 text-[#694aff] hover:cursor-pointer" />
                <div className="flex flex-col">
                    <label htmlFor="day" className={`label-date text-gray-500`}>DAY</label>
                    <input type="number" id="day" placeholder="DD" required className="input-date"></input>
                ...
                <div className="flex flex-col">
                    ...
                    <input type="number" id="month" placeholder="MM" required className="input-date ml-3"></input>
                ...
                <div className="flex flex-col">
                    ...
                    <input type="number" id="year" placeholder="YYYY" required className="input-date ml-3"></input>
